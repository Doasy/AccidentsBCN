...
def create_folders():
    if not os.path.exists('../data'):
        os.mkdir('../data')
    if not os.path.exists('../data/row'):
        os.mkdir('../data/row')
    for i in range(2010,2019):
        if not os.path.exists('../data/row/'+str(i)):
            os.mkdir('../data/row/'+str(i))	
...
def download_accidents():
    ...
    accidents2010.to_csv('../data/row/2010/accidents.csv', index=False)
    ...
    accidents2011.to_csv('../data/row/2011/accidents.csv', index=False)
    ...
    accidents2012.to_csv('../data/row/2012/accidents.csv', index=False)
    ...
    accidents2013.to_csv('../data/row/2013/accidents.csv', index=False)
    ...
    accidents2014.to_csv('../data/row/2014/accidents.csv', index=False)
    ...
    accidents2015.to_csv('../data/row/2015/accidents.csv', index=False)
    ...
    accidents2016.to_csv('../data/row/2016/accidents.csv', index=False)
    ...
    accidents2017.to_csv('../data/row/2017/accidents.csv', index=False)
    ...
    accidents2018.to_csv('../data/row/2018/accidents.csv', index=False)
...
def download_causes():
    ...
    causes2010.to_csv('../data/row/2010/causes.csv', index=False)
    ...
    causes2011.to_csv('../data/row/2011/causes.csv', index=False)
    ...
    causes2012.to_csv('../data/row/2012/causes.csv', index=False)
    ...
    causes2013.to_csv('../data/row/2013/causes.csv', index=False)
    ...
    causes2014.to_csv('../data/row/2014/causes.csv', index=False)
    ...
    causes2015.to_csv('../data/row/2015/causes.csv', index=False)
    ...
    causes2016.to_csv('../data/row/2016/causes.csv', index=False)
    ...
    causes2017.to_csv('../data/row/2017/causes.csv', index=False)
    ...
    causes2018.to_csv('../data/row/2018/causes.csv', index=False)
...
def download_persones():
    ...
    persones2010.to_csv('../data/row/2010/persones.csv', index=False)
    ...
    persones2011.to_csv('../data/row/2011/persones.csv', index=False)
    ...
    persones2012.to_csv('../data/row/2012/persones.csv', index=False)
    ...
    persones2013.to_csv('../data/row/2013/persones.csv', index=False)
    ...
    persones2014.to_csv('../data/row/2014/persones.csv', index=False)
    ...
    persones2015.to_csv('../data/row/2015/persones.csv', index=False)
    ...
    persones2016.to_csv('../data/row/2016/persones.csv', index=False)
    ...
    persones2017.to_csv('../data/row/2017/persones.csv', index=False)
    ...
    persones2018.to_csv('../data/row/2018/persones.csv', index=False)
...
def download_tipus():
    ...
    tipus2010.to_csv('../data/row/2010/tipus.csv', index=False)
    ...
    tipus2011.to_csv('../data/row/2011/tipus.csv', index=False)
    ...
    tipus2012.to_csv('../data/row/2012/tipus.csv', index=False)
    ...
    tipus2013.to_csv('../data/row/2013/tipus.csv', index=False)
    ...
    tipus2014.to_csv('../data/row/2014/tipus.csv', index=False)
    ...
    tipus2015.to_csv('../data/row/2015/tipus.csv', index=False)
    ...
    tipus2016.to_csv('../data/row/2016/tipus.csv', index=False)
    ...
    tipus2017.to_csv('../data/row/2017/tipus.csv', index=False)
    ...
    tipus2018.to_csv('../data/row/2018/tipus.csv', index=False)
...
def download_vehicles():
    ...
    vehicles2010.to_csv('../data/row/2010/vehicles.csv', index=False)
    ...
    vehicles2011.to_csv('../data/row/2011/vehicles.csv', index=False)
    ...
    vehicles2012.to_csv('../data/row/2012/vehicles.csv', index=False)
    ...
    vehicles2013.to_csv('../data/row/2013/vehicles.csv', index=False)
    ...
    vehicles2014.to_csv('../data/row/2014/vehicles.csv', index=False)
    ...
    vehicles2015.to_csv('../data/row/2015/vehicles.csv', index=False)
    ...
    vehicles2016.to_csv('../data/row/2016/vehicles.csv', index=False)
    ...
    vehicles2017.to_csv('../data/row/2017/vehicles.csv', index=False)
    ...
    vehicles2018.to_csv('../data/row/2018/vehicles.csv', index=False)
...
def download_districtes_i_barris():	
    ...
    districtes_i_barris.to_csv('../data/row/districtes_i_barris.csv', index=False)
...
def download_domicilis_sexe():
    ...
    domicilis_sexe2010.to_csv('../data/row/2010/domicilis_sexe.csv', index=False)
    ...
    domicilis_sexe2011.to_csv('../data/row/2011/domicilis_sexe.csv', index=False)
    ...
    domicilis_sexe2012.to_csv('../data/row/2012/domicilis_sexe.csv', index=False)
    ...
    domicilis_sexe2013.to_csv('../data/row/2013/domicilis_sexe.csv', index=False)
    ...
    domicilis_sexe2014.to_csv('../data/row/2014/domicilis_sexe.csv', index=False)
    ...
    domicilis_sexe2015.to_csv('../data/row/2015/domicilis_sexe.csv', index=False)
    ...
    domicilis_sexe2016.to_csv('../data/row/2016/domicilis_sexe.csv', index=False)
    ...
    domicilis_sexe2017.to_csv('../data/row/2017/domicilis_sexe.csv', index=False)
    ...
    domicilis_sexe2018.to_csv('../data/row/2018/domicilis_sexe.csv', index=False)
	
	
def download_padro_ocupacio():
    padro_ocupacio2010 = pd.read_csv('https://opendata-ajuntament.barcelona.cat/data/dataset/56568d9d-651a-49ff-bbc8-52d3fcee4421/resource/6ea29e87-29b2-4509-b6db-60508f82e5d4/download/2010_padro_ocupacio_mitjana.csv', encoding='ISO-8859-1')
    padro_ocupacio2010.to_csv('../data/row/2010/padro_ocupacio.csv', index=False)
    padro_ocupacio2011 = pd.read_csv('https://opendata-ajuntament.barcelona.cat/data/dataset/56568d9d-651a-49ff-bbc8-52d3fcee4421/resource/b2cbcaa1-4382-40f5-8ddc-039add86547b/download/2011_padro_ocupacio_mitjana.csv', encoding='ISO-8859-1')
    padro_ocupacio2011.to_csv('../data/row/2011/padro_ocupacio.csv', index=False)
    padro_ocupacio2012 = pd.read_csv('https://opendata-ajuntament.barcelona.cat/data/dataset/56568d9d-651a-49ff-bbc8-52d3fcee4421/resource/7109d8b9-298b-4084-a6fc-33605b3d2812/download/2012_padro_ocupacio_mitjana.csv', encoding='ISO-8859-1')
    padro_ocupacio2012.to_csv('../data/row/2012/padro_ocupacio.csv', index=False)
    padro_ocupacio2013 = pd.read_csv('https://opendata-ajuntament.barcelona.cat/data/dataset/56568d9d-651a-49ff-bbc8-52d3fcee4421/resource/a3665b68-067c-43d3-b476-176adb05e1f1/download/2013_padro_ocupacio_mitjana.csv', encoding='ISO-8859-1')
    padro_ocupacio2013.to_csv('../data/row/2013/padro_ocupacio.csv', index=False)
    padro_ocupacio2014 = pd.read_csv('https://opendata-ajuntament.barcelona.cat/data/dataset/56568d9d-651a-49ff-bbc8-52d3fcee4421/resource/d1fc8bbd-38f2-478b-b470-246de9bfdeea/download/2014_padro_ocupacio_mitjana.csv', encoding='ISO-8859-1')
    padro_ocupacio2014.to_csv('../data/row/2014/padro_ocupacio.csv', index=False)
    padro_ocupacio2015 = pd.read_csv('https://opendata-ajuntament.barcelona.cat/data/dataset/56568d9d-651a-49ff-bbc8-52d3fcee4421/resource/301c14bf-1097-4003-860b-da9ad027eb2b/download/2015_padro_ocupacio_mitjana.csv', encoding='ISO-8859-1')
    padro_ocupacio2015.to_csv('../data/row/2015/padro_ocupacio.csv', index=False)
    padro_ocupacio2016 = pd.read_csv('https://opendata-ajuntament.barcelona.cat/data/dataset/56568d9d-651a-49ff-bbc8-52d3fcee4421/resource/09026d72-aed9-444d-b0bd-5f92c81ece07/download/2016_padro_ocupacio_mitjana.csv', encoding='ISO-8859-1')
    padro_ocupacio2016.to_csv('../data/row/2016/padro_ocupacio.csv', index=False)
    padro_ocupacio2017 = pd.read_csv('https://opendata-ajuntament.barcelona.cat/data/dataset/56568d9d-651a-49ff-bbc8-52d3fcee4421/resource/c27464bd-1c3c-4a00-b2f4-2968ad07236e/download/2017_padro_ocupacio_mitjana.csv', encoding='ISO-8859-1')
    padro_ocupacio2017.to_csv('../data/row/2017/padro_ocupacio.csv', index=False)
    padro_ocupacio2018 = pd.read_csv('https://opendata-ajuntament.barcelona.cat/data/dataset/56568d9d-651a-49ff-bbc8-52d3fcee4421/resource/fb4f3e52-8997-4cc0-80be-bebbd850354d/download/2018_padro_ocupacio_mitjana.csv', encoding='ISO-8859-1')
    padro_ocupacio2018.to_csv('../data/row/2018/padro_ocupacio.csv', index=False)
